...
(function($) {
    ...
    this.create = function() {
      var $search = $('<input />', {
          ...
          $searchSpan = $('<span></span>', {
            ...
            text: (typeof settings.inputs.labelSearch === "string" ? settings.inputs.labelSearch : 'Search: ')
          }).append($search);
  ...
  function PaginationLinks(obj, settings) {
    ...
    this.create = function() {
      ...
      pageLinks += '<li><span>'+(typeof settings.inputs.labelPages === "string" ? settings.inputs.labelPages : 'Pages: ')+'</span></li>';
