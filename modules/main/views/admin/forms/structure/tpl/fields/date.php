<?php defined('SYSPATH') or die('No direct access allowed.'); ?>
	...
	<div class="js-settigs-holder" data-type="date">
		...
		<div class="control-group">
			<label class="control-label" for="js-field-current_time-{{id}}">Текущая дата по умолчанию:</label>
			<div class="controls">
				<input type="hidden" name="set[{{id}}][current_time]" value="0" />
				<input type="checkbox" id="js-field-current_time-{{id}}" name="set[{{id}}][current_time]" value="1" {{#current_time}}checked="checked"{{/current_time}} />
			</div>
		</div>
	</div>