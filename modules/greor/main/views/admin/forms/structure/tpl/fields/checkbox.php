<?php defined('SYSPATH') or die('No direct access allowed.'); ?>
	...
	<div class="js-settigs-holder" data-type="checkbox">
		...
		<div class="control-group">
			...
			<div class="controls">
				<input type="hidden" name="set[{{id}}][default]" value="0" />
				<input type="checkbox" id="js-field-default-{{id}}" name="set[{{id}}][default]" value="1" {{#default}}checked="checked"{{/default}} />
			</div>
		</div>
		<div class="control-group">
