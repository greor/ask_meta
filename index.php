 ...
 * Force SSL if needed.
 */
if (isset($_SERVER['HTTP_X_SERVER_PORT']) AND $_SERVER['HTTP_X_SERVER_PORT'] === '443')
{
	$_SERVER['HTTPS'] = '1';
}
 ...
 */
echo Request::factory(TRUE, HTTP_Cache::factory('file', array('cache_key_callback' => 'my_cache_key_generator')))
	->execute()
	->send_headers(TRUE)
	->body();
