...
class Kohana_ORM_Base extends ORM {
	...
	/**
	 * Using site_id_filter flag
	 * @var string
	 */
	protected $_use_site_id_filter = TRUE;
	...
	{
		if ($this->_use_site_id_filter AND $this->_site_id !== NULL AND isset($this->_table_columns[$this->_site_id_column]))
		{
	...
	protected function _validation()
	{
		...
		$this->_validation = Validation_Ext::factory($this->_object)
			->bind(':model', $this)
